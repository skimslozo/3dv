...
def main(_):
  ...
  try:
    while True:
      ...
      pixcoord2 = procOut(env._env._env.get_pixel_coordinates(2), [2, 1])
      ...
      #img.save(PATH +os.path.sep+'step_'+str(1)+'.png', format='png')
      img.save('pictures/step3_'+str(obs['steps_left'])+'.png', format='png')
      img.close()
